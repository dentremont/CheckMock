...
class Auth extends CI_Controller
{
	...
	function login()
	{
		$data['domain'] = $this->functions->validDomain();
		if(!$data['domain']) {
		...
		if ($this->tank_auth->is_logged_in()) {									// logged in
			...
			if ($this->form_validation->run()) {								// validation ok
				if (!is_null($data = $this->tank_auth->create_user(
					...
					// Create account
					$this->Account_m->create_account($this->form_validation->set_value('domain'), $this->form_validation->set_value('account_name'), $data['user_id']);
