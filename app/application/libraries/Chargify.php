...
class Chargify {
	...
	protected $username 	= 'v2YSAERa3q_B4oFTJQE6';		// Chargify API key
	protected $domain 		= 'checkmockapp';		// Chargify subdomain
	protected $password 	= 'kcomkcehc109';		// Chargify password (do not change)
